...
namespace Impala
{
    public static class Generic
    {
        ...
        static private IGH_Goo Gooify<T>(T data)
            where T: IGH_Goo
        {
            return data;
        }
        ...
        // Todo: bench this on looooong lists
        ...
        /// Aapplies GH's default tree matching logic when applying an action that takes in two datatrees. 
        /// </summary>
        public static GH_Structure<R> ZipMaxManual<T, Q, R>(GH_Structure<T> a, GH_Structure<Q> b, Func<T, Q, R> action)
            where T : IGH_Goo
            where Q : IGH_Goo
            where R : IGH_Goo
        {
            ...
            var paths = GetPathList(a.DuplicateCast(Gooify), b.DuplicateCast(Gooify));
